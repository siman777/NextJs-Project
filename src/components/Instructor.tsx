  ...
  return (
    <div className="h-[40rem] relative overflow-hidden flex items-center justify-center">
      <WavyBackground
        ...
        "
      >
        <h1 className=" font-bold text-2xl md:text-4xl lg:text-7xl text-white text-center mb-8">
          Meet Our Instructors
        </h1>
        <p className="text-base md:text-lg text-white-700 text-center mb-4">
          Discover the taltent Professionals who will guide your musical journey
        </p>
