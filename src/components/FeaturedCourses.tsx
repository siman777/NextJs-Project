...
import music_course from "../data/music_course.json";
...
const FeaturedCourses = () => {
  const featuredContent = music_course.courses.filter(
    ...
    <div className="py-12 bg-gray-900">
      <div>
        <div className="text-center">
          <h2 className="text-lg md:text-xl font-bold text-teal-700 tracking-wider uppercase">
            Featured Courses
          </h2>
          <p
      ...
      <div className="mt-10">
        <div className="grid grid-col-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
          {featuredContent.map((course: Course) => (
